...
INSTALLED_APPS = list(SHARED_APPS) + list(EXTRA_APPS)
...
DATABASES = {
    'default': dj_database_url.config(
        default="postgres://warehouse:warehouse@db:5432/warehouse"
    ),
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'warehouse.api.core.pagination.PageNumberPagination',
...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "warehouse.core.logging.JsonFormatter",
    ...
    "loggers": {
        ...
        "warehouse": {"level": "DEBUG", "propagate": True},
    },
}
